...
public class LoguinBbsGestion extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //}catch(Exception ex){
            ...
            /*
            usuarios.setNumero(1);
            usuarios.setNumeroId(1);
            usuarios.setEquipo(1);
            usuarios.setNivel(1);
            usuarios.setSucursal(new Sucursales(1));
            usuarios.setMenu(new Menus(true,true,true,true,true,true,true));                    
            */
        //}
        ...
        in.setTitle(" SISTEMA DE GESTION // POCO PRECIO --  USUARIO : "+Inicio.usuario.getNombre()+" SUCURSAL :"+Inicio.sucursal.getNumero()+" - "+Inicio.sucursal.getDescripcion());
